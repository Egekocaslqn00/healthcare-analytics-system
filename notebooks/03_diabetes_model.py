...
Trains and evaluates multiple ML models for diabetes prediction
"""
...
# Replace zeros with NaN for specific columns (medical impossibility)
...
if 'Random Forest' in best_model_name or 'XGBoost' in best_model_name:
    ...
    joblib.dump(best_model, '../models/diabetes_model_tuned.pkl')
...
axes[1, 1].plot(fpr, tpr, color='green', lw=2, 
...
plt.tight_layout()
plt.savefig('../reports/figures/diabetes_model_evaluation.png', dpi=300, bbox_inches='tight')
print("✓ Saved: diabetes_model_evaluation.png")
...
if hasattr(best_model, 'feature_importances_'):
    ...
    ax.set_title('Feature Importance - Diabetes Prediction', fontsize=14, fontweight='bold')
    ax.set_xlabel('Importance Score')
    ax.set_ylabel('Features')
    plt.tight_layout()
    plt.savefig('../reports/figures/diabetes_feature_importance.png', dpi=300, bbox_inches='tight')
...
results_df.to_csv('../reports/diabetes_model_results.csv', index=False)
print("\n✓ Saved: diabetes_model_results.csv")
